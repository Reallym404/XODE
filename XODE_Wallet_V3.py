...
html+='<span>⏰ '+date+'</span>';
if(supply.issued){html+='<span>📊 '+parseFloat(supply.issued).toFixed(8)+'</span>';}
if(supply.burned_total||supply.burned_total===0){html+='<span>🔥 Burned: '+parseFloat(supply.burned_total||0).toFixed(8)+'</span>';}
